    ...
    return (
        <Card className="w-auto rounded-lg bg-white shadow-lg mr-4">
            <CardBody>
                ...
                ">
                    <div className="flex flex-col w-64 mr-8 bg-blueMasferrer bg-opacity-70 pb-4 justify-center
                    px-14 rounded-2xl
                    ...
                    ">
                        ...
                        <Chip value={classroom1} className="bg-orange-900 text-white p-2 my-2 mx-auto
                    ...
                    <div className="flex flex-col mr-8 bg-blueMasferrer bg-opacity-70 pb-4 justify-center
                    ...
                    Mobile-280:my-4 Mobile-280:px-4 Mobile-280:mx-auto">
                        ...
                        <Chip value={classroom2} className="bg-orange-900 text-white p-2 my-2 mx-auto
                        font-masferrerTitle border rounded-full w-fit overflow-auto" />
