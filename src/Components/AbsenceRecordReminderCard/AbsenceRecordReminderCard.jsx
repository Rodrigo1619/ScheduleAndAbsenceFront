...
const AbsenceRecordReminderCard = ({ classroomName, classroomSection, todayAbsence}) => {
    return (
                    ...
                    border-opacity-20 border-2 bg-opacity-70 pb-4 px-1 my-6 rounded-2xl">
                        {
                            !classroomName || !classroomSection || !todayAbsence ? (
                                <div className="flex flex-row justify-center mx-auto mt-4 bg-red-600 py-1 rounded-2xl">
                                ...
                                (
                                    todayAbsence[0].teacherValidation ? (
                                        <div className="flex flex-row justify-center mx-auto mt-4 bg-green-500 py-1 rounded-2xl">
                                            <Typography className="text-white font-masferrerTitle font-normal text-xl">
                                                Se han registrado las inasistencias de hoy
                                            </Typography>
                                        </div>
                                        ) : (
                                            <div className="flex flex-row justify-center mx-auto mt-4 bg-yellow-800 py-1 rounded-2xl">
                                                <Typography className="text-white font-masferrerTitle font-normal text-xl">
