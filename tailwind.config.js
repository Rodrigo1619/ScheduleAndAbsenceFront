  ...
  theme: {
    extend: {
      colors: {
        ...
        blueCapas: "#2C3544",
        bluefooter: "#262D38",
        blueMasferrer: "#170973",
        darkblueMasferrer: "#030140",
      },
      width: {
        "1/7": "14.2857143%",
        "2/7": "28.5714286%",
        ...
        "CardGeneralContainerMobile-280": "150px",
        "CardGeneralImgPC-1920*1080": "350px",
        "CardGeneralImgPC-1600*900": "330px",
        "CardGeneralImgPC-1366*768": "275px",
        "CardGeneralImgPC-1280*720": "225px",
        "CardGeneralImgPC-800*600": "200px",
        "CardGeneralImgPC-640*480": "175px",
        "CardGeneralImgPC-320*240": "100px",
        "CardGeneralImgMobile-390*844": "275px",
        "CardGeneralImgMobile-280": "230px",
        "CardGeneralImgUltrawide34inch": "500px",
        "PermitContainerPC-1920*1080": "950px",
        "PermitContainerPC-1600*900": "1500px",
        "PermitContainerPC-1366*768": "1250px",
        "PermitContainerPC-1280*720": "1000px",
        "PermitContainerPC-800*600": "640px",
        "PermitContainerPC-640*480": "475px",
        "PermitContainerPC-320*240": "400px",
        "PermitContainerMobile-390*844": "275px",
        "PermitContainerMobile-280": "170px",
      },
      height: {
        "1/7": "14.2857143%",
        "2/7": "28.5714286%",
        ...
        "CarouselItemPC-1600*900": "575px",
        "CarouselItemPC-1366*768": "475px",
        "CarouselItemPC-1280*720": "450px",
        "CarouselItemPC-1024*768": "400px",
        "CarouselItemPC-800*600": "300px",
        "CarouselItemPC-640*480": "200px",
        "CarouselItemPC-320*240": "150px",
        ...
        "CardGeneralImgPC-1920*1080": "500px",
        "CardGeneralImgPC-1600*900": "450px",
        "CardGeneralImgPC-1366*768": "400px",
        "CardGeneralImgPC-1280*720": "350px",
        "CardGeneralImgPC-800*600": "300px",
        "CardGeneralImgPC-640*480": "250px",
        "CardGeneralImgPC-320*240": "200px",
        "CardGeneralImgMobile-390*844": "325px",
        "CardGeneralImgMobile-280": "200px",
        "CardGeneralImgUltrawide-34inch": "600px",
        "StaffContainerPC-1920*1080": "900px",
      },
      screens: {
        "PC-Ultrawide-34inch": { min: "3000px", max: "3500px" },
        "PC-1920*1080": { min: "1800px", max: "2000px" },
        "PC-1600*900": { min: "1600px", max: "1800px" },
        "PC-1366*768": { min: "1366px", max: "1599px" },
        "PC-1280*720": { min: "1000px", max: "1365px" },
        "PC-800*600": { min: "641px", max: "1000px" },
        "PC-640*480": { min: "500px", max: "641px" },
        "Mobile-390*844": { min: "300px", max: "500px" },
        "Mobile-280": { min: "200px", max: "300px" },
        "IpadAir": {
          raw: "(min-height: 740px) and (min-width: 710px) and (max-height:1368px) and (max-width: 950px)",
        },
      },
      fontSize: {
        "ButtonCarouselPC-1920*1080": "50px",
      ...
      fontFamily: {
        ...
        masferrerTitle: ["Roboto Condensed", "sans-serif"],
        masferrer: ["Roboto", "sans-serif"],
      },
    },
    plugins: [],
  },
